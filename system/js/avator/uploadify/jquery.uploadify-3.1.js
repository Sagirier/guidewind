		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					swf      : 'system/js/avator/uploadify/uploadify.swf',  // The path to the uploadify SWF file
					uploader : 'admin.php?action=avator&o=filemanager&filesdir=<?php echo $filesdir; ?>',  // The path to the server-side upload script
