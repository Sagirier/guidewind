var IMAGESPATH = 'manage/admin/template/img/'; 
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" width="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr style="background:#fff"><td align="right" style="padding-left:20px"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\
			<td align="left" style="padding-left:15px;color:#a6c31d" id="Message_' + this.ID + '" style="font-size:14px">' + msg + '</td></tr>\
	</table>';
    diag.show();
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%"  width="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr style="background:#fff"><td align="right" style="padding-left:20px"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_query.gif" width="34" height="34" align="absmiddle"></td>\
